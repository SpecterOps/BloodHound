...
import {
    ...
    ROUTE_PRIVILEGE_ZONES_SUMMARY_LABEL_DETAILS,
    ROUTE_PRIVILEGE_ZONES_SUMMARY_TIER_DETAILS,
    ROUTE_PRIVILEGE_ZONES_TIER_DETAILS,
    ROUTE_PRIVILEGE_ZONES_TIER_OBJECT_DETAILS,
    ROUTE_PRIVILEGE_ZONES_TIER_SELECTOR_DETAILS,
    ROUTE_PRIVILEGE_ZONES_TIER_SELECTOR_OBJECT_DETAILS,
    Routable,
} from '../../routes';
