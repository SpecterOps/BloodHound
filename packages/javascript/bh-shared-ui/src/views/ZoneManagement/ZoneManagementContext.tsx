...
import {
    ROUTE_PRIVILEGE_ZONES_LABEL_CREATE_SELECTOR,
    ROUTE_PRIVILEGE_ZONES_LABEL_UPDATE_SELECTOR,
    ROUTE_PRIVILEGE_ZONES_SAVE,
    ROUTE_PRIVILEGE_ZONES_TIER_CREATE_SELECTOR,
    ROUTE_PRIVILEGE_ZONES_TIER_UPDATE_SELECTOR,
    ROUTE_PRIVILEGE_ZONES_UPDATE_LABEL,
    ROUTE_PRIVILEGE_ZONES_UPDATE_TIER,
} from '../../routes';
