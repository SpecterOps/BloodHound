...
import { ROUTE_ZONE_MANAGEMENT_DETAILS, ROUTE_ZONE_MANAGEMENT_SUMMARY } from '../../routes';
                            ...
                            menuItems={[
                                {
                                    ...
                                    onClick: () => {
                                        navigate(
                                            `/zone-management/${ROUTE_ZONE_MANAGEMENT_SUMMARY}/${getTagUrlValue(labelId)}/${tagId}`
                                        );
                                    },
                                },
                                {
                                    title: 'Detail View',
                                    onClick: () => {
                                        navigate(`/zone-management/${ROUTE_ZONE_MANAGEMENT_DETAILS}`);
                                    },
                                },
                            ]}
                        />
                            ...
                            menuItems={[
                                {
                                    ...
                                    onClick: () => {
                                        navigate(
                                            `/zone-management/save/${buttonTitle.toLowerCase()}/${location.pathname.includes('label') ? labelId : tierId}`
                                        );
                                    },
                                },
                            ]}
