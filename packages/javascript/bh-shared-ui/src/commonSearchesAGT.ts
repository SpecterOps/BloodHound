    ...
    },
    {
        ...
        queries: [
            ...
            },
            {
                ...
                cypher: `MATCH p=shortestPath((s:Group)-[:AD_ATTACK_PATHS*1..]->(t:${TAG_TIER_ZERO_AGT}))\nWHERE s.objectid ENDS WITH '-513' AND s<>t\nRETURN p\nLIMIT 1000`,
            },
            {
    ...
    },
    {
        ...
        queries: [
            ...
            },
            {
                ...
                cypher: `MATCH p=shortestPath((s)-[:AD_ATTACK_PATHS*1..]->(t:${TAG_TIER_ZERO_AGT}))\nWHERE s<>t\nRETURN p\nLIMIT 1000`,
            },
            {
