...
export const ROUTE_TIER_MANAGEMENT_SUMMARY = '/summary';
export const ROUTE_TIER_MANAGEMENT_SUMMARY_TIER_DETAILS = '/summary/tier/:tierId';
export const ROUTE_TIER_MANAGEMENT_SUMMARY_LABEL_DETAILS = '/summary/label/:labelId';
