    ...
    return (
        <div className='flex flex-col gap-2 w-56'>
            ...
            <ManagedDatePicker
                ...
                value={startDate}
                validations={[VALIDATIONS.isBeforeDate(endDate, 'Start time must be before end time.')]}
            />
            ...
            <ManagedDatePicker
                ...
                value={endDate}
                validations={[VALIDATIONS.isAfterDate(startDate, 'End time must be after start time.')]}
            />
        </div>
    );
};
