                ...
                render={({ field }) => (
                    <FormControlLabel
                        ...
                        label={
                            <Typography
                                className={clsx(
                                    `ml-4 ${!watch('config.auto_provision.enabled') && 'dark:text-white dark:text-opacity-60 text-black text-opacity-60'}`
                                )}>
                ...
                render={({ field }) => (
                    <FormControlLabel
                        ...
                        label={
                            <Typography
                                className={clsx(
                                    `ml-4 ${!watch('config.auto_provision.role_provision') && 'dark:text-white dark:text-opacity-60 text-black text-opacity-60'}`
                                )}>
