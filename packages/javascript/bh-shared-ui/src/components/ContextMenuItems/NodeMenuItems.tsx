...
/**
 * Returns an ARRAY of node context menu item.
 *
 * MUI's `<Menu>` component does not supports fragments (<></>) so to
 * dynamically compose menu sections, arrays must be used.
 */
export const NodeMenuItems: FC = () => {
