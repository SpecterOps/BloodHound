...
const MainNav: FC<{ mainNavData: any }> = ({ mainNavData }) => {
    ...
    return (
        ...
        <nav
            className={`z-[1201] fixed top-0 left-0 h-full ${isMenuExpanded ? 'w-72 overflow-y-auto overflow-x-hidden' : 'w-[56px]'} duration-300 ease-in flex flex-col items-center pt-4  bg-neutral-light-2 text-neutral-dark-0 dark:bg-neutral-dark-2 dark:text-neutral-light-1 print:hidden shadow-sm`}
