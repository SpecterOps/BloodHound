...
import { disableActWarningsForAsync } from '../utils/testHelpers';
...
describe('AppNotifications', () => {
    ...
    it('renders a snackbar notification in the dom and tests autoHideDuration', async () => {
        ...
        await disableActWarningsForAsync(() => vi.advanceTimersByTimeAsync(SNACKBAR_DURATION + 1000));
    ...
    it('renders a snackbar notification in the dom and tests the long autoHideDuration', async () => {
        ...
        await disableActWarningsForAsync(() => vi.advanceTimersByTimeAsync(SNACKBAR_DURATION_LONG + 1000));
