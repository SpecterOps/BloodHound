    ...
    return (
        <>
            ...
            <Typography variant='body2'>
                ...
                templates, configured to: 1) enable certificate authentication, 2) require the userPrincipalName (UPN)
                of the enrollee included in the Subject Alternative Name (SAN), and 3) do not have the security
                extension enabled. The victim also has enrollment permission for an enterprise CA with the necessary
                ...
                certificate binding enforcement. This setup lets the principal impersonate any AD forest principal (user
            ...
            <Typography variant='body2'>
                ...
                match the sAMAccountName of a targeted principal. Example: If the targeted principal is
                ...
                find a principal with a sAMAccountName matching the SAN value and find the targeted user. At last, the
                DC issues a Kerberos TGT as the targeted user to the attacker, which means the attacker now has a
                session as the targeted user. In case the target is a computer, the DC will find it as well as the DC
                will attempt sAMAccountName matching with a $ at the end of the SAN value as last resort.
            </Typography>
        </>
    );
};
