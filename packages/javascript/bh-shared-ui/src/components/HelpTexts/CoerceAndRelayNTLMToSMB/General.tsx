...
const General: FC<EdgeInfoProps> = () => {
    return (
        <>
            ...
            <Typography variant='body2'>
                Click on Relay Sources to view valid computers with administrative rights on the target computer that can be relayed.
                Click on Composition to view the full paths that lead to administrative rights on the target computer.
            </Typography>
        </>
    );
};
