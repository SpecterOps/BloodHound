    ...
    return (
        <>
            <Typography variant='body2'>
                ...
                computer’s actual IP address. This detection technique is described in the blog post: <a
                href={"https://posts.bluraven.io/detecting-ntlm-relay-attacks-d92e99e68fb9"}>Detecting NTLM Relay
                Attacks</a>.
            </Typography>
            ...
            <Typography variant={'body2'}>
                ...
                These detection techniques are described in detail under DETECT2 in the whitepaper:
                <a href={"https://specterops.io/wp-content/uploads/sites/3/2022/06/Certified_Pre-Owned.pdf"}>Certified Pre-Owned.</a>
            </Typography>
        </>
    );
};
