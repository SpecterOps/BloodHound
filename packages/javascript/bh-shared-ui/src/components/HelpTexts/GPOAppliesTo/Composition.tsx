    ...
    return (
        <>
            <Typography variant='body2'>
                ...
                different objects. The composition graph shows where the GPO is linked to making it apply to the target principal. All objects involved in the creation of this relationship are listed here:
            </Typography>
            <Box py={1}>
                {isLoading ? (
