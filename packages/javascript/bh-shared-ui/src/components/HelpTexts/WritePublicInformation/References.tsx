...
const References: FC = () => {
    return (
        <Box className='overflow-x-auto'>
            ...
            <br />
            <Link target='_blank' rel='noopener noreferrer' href='https://linux.die.net/man/1/ldapsearch'>
                ldapsearch
            </Link>
            <br />
            <Link target='_blank' rel='noopener noreferrer' href='https://linux.die.net/man/1/ldapmodify'>
                ldapmodify
            </Link>
            <br />
            <Link
