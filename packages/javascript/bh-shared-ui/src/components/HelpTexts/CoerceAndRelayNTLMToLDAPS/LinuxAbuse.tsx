    ...
    return (
        <>
            <Typography variant='body2'>
                ...
                <li><a
                    href={"https://www.guidepointsecurity.com/blog/beyond-the-basics-exploring-uncommon-ntlm-relay-attack-techniques/"}>Beyond
                    the Basics: Exploring Uncommon NTLM Relay Attack Techniques</a></li>
                <li><a
