    ...
    return (
        <Box className='overflow-x-auto'>
            ...
            <Link
                ...
                href='https://learn.microsoft.com/en-us/powershell/module/activedirectory/restore-adobject?view=windowsserver2025-ps'>
            ...
            <Link
                target='_blank'
                rel='noopener noreferrer'
                href='https://www.ultimatewindowssecurity.com/securitylog/encyclopedia/event.aspx?eventID=4738'>
