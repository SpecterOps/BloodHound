    ...
    return (
        <>
            <Typography variant='body2'>
                groupSpecialFormat(sourceType, sourceName) the ability to reactivate the deleted object currently in the
                Active Directory Recycle Bin into a location where this user has direct or inherited{' '}
            ...
            <Typography variant='body2'>
                ...
                <pre style={{ display: 'inline', width: 'fit-content' }}>CreateChild</pre> permissions.
            </Typography>
