...
const General: FC<EdgeInfoProps> = ({ sourceName, sourceType, targetName, targetType }) => {
    return (
        <>
            ...
            <Typography variant='body2'>
                The owner of an object is implicitly granted the ability to modify object security descriptors,
                including the DACL, when the following conditions are met:
                <br />
                <ul>
                    <li>The OWNER RIGHTS SID (S-1-3-4) is not explicitly granted privileges on the object</li>
                    ...
                    <br />
                    <br />
                    <li>Implicit owner rights are not blocked</li>
                </ul>
            </Typography>
            ...
            <Typography variant='body2'>
                ...
                <ul>
                    ...
                    <br />
                    <br />
                    <li>The object is not a computer or derivative of a computer object (e.g., MSA, GMSA)</li>
                    <br />
                    OR
                    <br />
                    <br />
                    <li>
                        The object is a computer or derivative of a computer object and the owner is a member of the
                        Domain Admins or Enterprise Admins group (or is the SID of either group)
                    </li>
                </ul>
            </Typography>
        </>
