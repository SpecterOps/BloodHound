            ...
            return (
                <>
                    ...
                    <Typography variant='body2'>
                        ...
                        such as objects protected by AdminSDHolder (attribute adminCount=1). This observation applies to any OU child object with inheritance disabled, including objects located in nested sub-OUs.
                    </Typography>
