...
const References: FC = () => {
    return (
        <Box sx={{ overflowX: 'auto' }}>
            ...
            <br />
            <Link target='_blank' rel='noopener noreferrer' href='https://attack.mitre.org/wiki/Technique/T1175'>
            ...
            <Link
                target='_blank'
                rel='noopener noreferrer'
                href='https://codewhitesec.blogspot.com/2018/07/lethalhta.html'>
                https://codewhitesec.blogspot.com/2018/07/lethalhta.html
            </Link>
            <br />
            <Link target='_blank' rel='noopener noreferrer' href='https://github.com/codewhitesec/LethalHTA/ '>
