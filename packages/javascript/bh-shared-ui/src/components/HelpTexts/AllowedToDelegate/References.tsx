...
const References: FC = () => {
    return (
        <Box className='overflow-x-auto'>
            ...
            <br />
            <Link target='_blank' rel='noopener noreferrer' href='https://blog.harmj0y.net/activedirectory/s4u2pwnage/'>
            ...
            <Link
                target='_blank'
                rel='noopener noreferrer'
                href='https://twitter.com/gentilkiwi/status/806643377278173185'>
            ...
            <Link
                target='_blank'
                rel='noopener noreferrer'
                href='https://blog.harmj0y.net/redteaming/from-kekeo-to-rubeus/'>
