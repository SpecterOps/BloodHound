        ...
        case 'Domain':
            return (
                <>
                    ...
                    <Typography variant='body2'>
                        You can also abuse this without using Windows-based tooling if you are operating from a Linux
                        host. DCSync.py from n00py will let you authenticate with either a plaintext password, NT hash,
                        or kerberos ticket:
                    </Typography>
                    <Typography variant='body2'>
                ...
                <>
                    ...
                    <Typography variant='body2'>
                        ...
                        {sourceType === 'User'
                            ? `${sourceName} if you are not running a process as that user`
                            : `a member of ${sourceName} if you are not running a process as a member`}{' '}
                        if you are not running a process as a member of that group. To do this in conjunction with
                        Add-DomainObjectACL, first create a PSCredential object (these examples comes from the PowerView
                        help documentation):
                    </Typography>
                    <Typography component={'pre'}>
                        {"$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force\n" +
                    ...
                    <Typography variant='body2'>
                        Then, use Add-DomainObjectAcl, optionally specifying $Cred if you are not already running a
                        process as a member of (group that holds the ACE against the OU):
                    </Typography>
                    <Typography component={'pre'}>
                    ...
                    <Typography variant='body2'>
                        ...
                        <Typography component={'pre'}>00000000-0000-0000-0000-000000000000</Typography>:
                    </Typography>
                    <Typography component={'pre'}>
