...
export const brand = {
    ...
    medium_purple: '#8E92EB', // can this color be updated to match the purple below?
    light_purple: '#D7D6E6',
    ...
    purple: {
        light: '#A1A0FF', // same as dark.primary.main
    ...
    blue: {
        ...
        light: '#81D4FA', // only used in Badge? badge.blue.fill
        medium: '#66A3FF', // same as dark.secondary.main
        dark: '#0288D1', // only used in Badge? badge.blue.outline
