...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.Content
        ref={ref}
        className={cn('mt-2 rounded-sm focus:outline-none focus-visible:focus-ring', className)}
        {...props}
    />
));
