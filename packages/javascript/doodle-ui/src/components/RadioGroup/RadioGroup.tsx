...
const RadioItem = React.forwardRef<React.ElementRef<typeof RadioGroupPrimitive.Item>, RadioGroupItemProps>(
    ({ className, label, value, ...props }, ref) => (
        <Label className='flex items-center font-normal cursor-pointer mb-1 mr-4 rounded-md [&:has(:focus-visible)]:ring-2 [&:has(:focus-visible)]:ring-secondary ring-offset-1 ring-offset-neutral-2 bg-neutral-2 px-1 -mx-1'>
