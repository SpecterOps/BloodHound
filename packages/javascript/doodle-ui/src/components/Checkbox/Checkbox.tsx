...
const CheckboxVariants = cva(
    'peer shrink-0 rounded-sm border border-checkbox-border dark:border-checkbox-border dark:hover:border-checkbox-hover dark:active:border-primary-variant ring-offset-background focus:outline-none focus-visible:focus-ring disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-neutral-dark-1 data-[state=checked]:text-neutral-light-1 dark:data-[state=checked]:bg-primary-main dark:data-[state=checked]:hover:bg-checkbox-hover dark:data-[state=checked]:active:bg-primary-variant dark:data-[state=checked]:text-neutral-dark-1 enabled:hover:data-[state=indeterminate]:border-secondary enabled:hover:data-[state=indeterminate]:bg-secondary dark:disabled:bg-input-fill-disabled dark:disabled:border-input-border-disabled dark:hover:disabled:border-input-border-disabled enabled:active:border-primary-variant enabled:data-[state=checked]:border-primary enabled:data-[state=checked]:bg-primary enabled:data-[state=checked]:text-neutral-light-1 enabled:data-[state=indeterminate]:border-primary enabled:data-[state=indeterminate]:bg-primary enabled:data-[state=indeterminate]:text-neutral-light-1 enabled:dark:data-[state=checked]:text-neutral-dark-1 enabled:dark:data-[state=indeterminate]:text-neutral-dark-1 disabled:cursor-not-allowed disabled:border-input-border-disabled disabled:bg-input-fill-disabled disabled:text-icon-disabled enabled:aria-[invalid=true]:border-status-error-main enabled:aria-[invalid=true]:text-status-error-main enabled:aria-[invalid=true]:data-[state=checked]:border-status-error-main enabled:aria-[invalid=true]:data-[state=checked]:bg-status-error-main enabled:aria-[invalid=true]:data-[state=checked]:text-neutral-light-1 enabled:aria-[invalid=true]:data-[state=indeterminate]:border-status-error-main enabled:aria-[invalid=true]:data-[state=indeterminate]:bg-status-error-main enabled:aria-[invalid=true]:data-[state=indeterminate]:text-neutral-light-1 enabled:dark:aria-[invalid=true]:data-[state=checked]:text-neutral-dark-1 enabled:dark:aria-[invalid=true]:data-[state=indeterminate]:text-neutral-dark-1',
    {
        variants: {
            size: {
                lg: 'size-[24px]',
