...
func Run(paths workspace.WorkspacePaths, env environment.Environment, fix bool, outputAllSeverity bool) error {
	if golintResults, err := golang.Run(paths.Root, paths.GoModule, env, fix); err != nil {
