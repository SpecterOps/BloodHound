...
func (s IDA) popDependencies(targetUint32ID uint64) []uint64 {
...
func (s IDA) membership(targetUint32ID uint64) cardinality.Provider[uint64] {
...
// it
func (s IDA) resolve(targetUint32ID uint64) cardinality.Provider[uint64] {
	var (
