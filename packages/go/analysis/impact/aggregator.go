...
func (s Aggregator) popDependencies(targetUint32ID uint64) []uint64 {
...
func (s Aggregator) getImpact(targetUint32ID uint64) cardinality.Provider[uint64] {
...
// it
func (s Aggregator) resolve(targetUint32ID uint64) cardinality.Provider[uint64] {
	var (
