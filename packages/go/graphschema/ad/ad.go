...
func ParseProperty(source string) (Property, error) {
	...
	case "isdc":
		return IsDC, nil
	case "enrollmentendpoints":
		return EnrollmentEndpoints, nil
...
func (s Property) String() string {
	...
	case IsDC:
		return string(IsDC)
	case EnrollmentEndpoints:
		return string(EnrollmentEndpoints)
	case HasVulnerableEndpoint:
