...
func (m *MockValueMapper) Len() int {
	m.ctrl.T.Helper()
...
func (mr *MockValueMapperMockRecorder) Count() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Count", reflect.TypeOf((*MockValueMapper)(nil).Len))
}
...
func (mr *MockValueMapperMockRecorder) Map(target any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValueMapperMockRecorder) MapOptions(target ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockNodeQueryMockRecorder) Fetch(delegate any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
