...
export const useMainNavLogoData = (): MainNavData['logo'] => {
    ...
    return {
        project: {
            ...
            icon: <AppIcon.BHCELogo size={26} className='scale-150 mt-2' />, // Note: size 26 icon looked too small in comparison so had to scale it up a bit because upping the size misaligns it
            image: {
