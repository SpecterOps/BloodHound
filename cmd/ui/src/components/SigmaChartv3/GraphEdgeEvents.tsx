...
import { getControlPointsFromGroupSize } from 'src/rendering/utils/utils';
...
export const GraphEdgeEvents: FC<GraphEdgeEventProps> = ({ onClickEdge, sigma }) => {
    const { mouse: mouseCanvas, edgeLabels: edgeLabelsCanvas } = sigma.getCanvases();
