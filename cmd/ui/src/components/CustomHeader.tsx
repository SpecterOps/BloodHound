...
import { faChartLine, faCog, faProjectDiagram, faSitemap } from '@fortawesome/free-solid-svg-icons';
        ...
        return (
            <>
                <div className={classes.menu}>
                    <MenuItem
                        title={'Attack Paths'}
                        icon={<FontAwesomeIcon icon={faSitemap} size='sm' />}
                        active={location.pathname === '/attack-paths'}
                        onClick={() => navigate('/attack-paths')}
                        data-testid='global_header_nav-attack-paths'
                    />
                    <MenuItem
                        title={'Explore'}
                    ...
                    <MenuItem
                        ...
                        active={location.pathname === '/posture'}
                        onClick={() => navigate('/posture')}
                        data-testid='global_header_nav-posture'
                    />
                </div>
