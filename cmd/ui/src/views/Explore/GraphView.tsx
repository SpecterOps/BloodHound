...
const GridItems = () => {
    const columnsDefault = { xs: 6, md: 5, lg: 4 };
    const cypherSearchColumns = { xs: 6, md: 6, lg: 6 };
    ...
    return [
        <Grid item xs={columns.xs} md={columns.md} lg={columns.lg} sx={{ height: '100%' }} key={'exploreSearch'}>
