...
type PersistedState = {
    ...
    global: { view: { darkMode: boolean; nodeLabelsMode: boolean; edgeLabelsMode: boolean; notifications: string[]} };
};
        ...
        saveState({
            ...
            global: {
                view: {
                    ...
                    nodeLabelsMode: state.global.view.nodeLabelsMode,
                    edgeLabelsMode: state.global.view.edgeLabelsMode,
                    notifications: [],
                },
            },
        });
