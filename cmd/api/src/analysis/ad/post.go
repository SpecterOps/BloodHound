...
func Post(ctx context.Context, db graph.Database, adcsEnabled bool, citrixEnabled bool, compositionCounter *analysis.CompositionCounter) (*analysis.AtomicPostProcessingStats, error) {
