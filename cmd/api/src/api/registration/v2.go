...
func NewV2API(resources v2.Resources, routerInst *router.Router) {
	...
	router.With(func() mux.MiddlewareFunc {
		...
		routerInst.GET(fmt.Sprintf("/api/v2/computers/{%s}/backup-rights", api.URIPathVariableObjectID), resources.ListADEntityBackupRights).RequirePermissions(permissions.GraphDBRead),
		...
		routerInst.GET(fmt.Sprintf("/api/v2/users/{%s}/backup-rights", api.URIPathVariableObjectID), resources.ListADEntityBackupRights).RequirePermissions(permissions.GraphDBRead),
		...
		routerInst.GET(fmt.Sprintf("/api/v2/groups/{%s}/backup-rights", api.URIPathVariableObjectID), resources.ListADEntityBackupRights).RequirePermissions(permissions.GraphDBRead),
