...
<<<<<<< HEAD
=======
		routerInst.GET("/api/v2/asset-group-tags/search", resources.SearchAssetGroupTags).CheckFeatureFlag(resources.DB, appcfg.FeatureTierManagement).RequirePermissions(permissions.GraphDBRead),
...
>>>>>>> 01d999013 (added some filtering for tags and selectors)
