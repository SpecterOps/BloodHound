...
func NewV2API(resources v2.Resources, routerInst *router.Router) {
	...
	routerInst.POST(fmt.Sprintf("/api/v2/file-upload/{%s}/multipart", v2.FileUploadJobIdPathParameterName), resources.ProcessMultipartIngestTask).RequirePermissions(permissions.GraphDBIngest)
