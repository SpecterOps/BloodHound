...
import (
	...
	queriesMocks "github.com/specterops/bloodhound/cmd/api/src/queries/mocks"
...
func TestResources_UpdateAssetGroupSelectors_SuccessT0(t *testing.T) {
	...
	mockDB.EXPECT().RequestAnalysis(gomock.Any(), uuid.UUID{}.String(), model.AnalysisModeTaggingOnwards)
...
func TestResources_UpdateAssetGroupSelectors_SuccessOwned(t *testing.T) {
	...
	mockDB.EXPECT().RequestAnalysis(gomock.Any(), uuid.UUID{}.String(), model.AnalysisModeTaggingOnwards).Times(0)
