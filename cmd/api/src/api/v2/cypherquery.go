...
func processCypherProperties(graphResponse model.UnifiedGraph) CypherGraphKey {
	...
	keys := CypherGraphKey{NodeKeys: nSlice, EdgeKeys: eSlice, Edges: graphResponse.Edges, Nodes: graphResponse.Nodes}
	return keys
}
