...
func (s *Context) GetAuditLogsBetween(after, before time.Time, offset, limit int) model.AuditLogs {
	auditLogsResponse, err := s.AdminClient().GetAuditLogsBetween(after, before, offset, limit)
