...
func TestResources_CypherQuery(t *testing.T) {
	...
	intentAuditEntry := model.AuditEntry{
		Action: model.AuditLogActionRunCypherQuery,
	...
	successAuditEntry := intentAuditEntry
	successAuditEntry.Status = model.AuditLogStatusSuccess
	failureAuditEntry := intentAuditEntry
	failureAuditEntry.Status = model.AuditLogStatusFailure

	unauthorizedAccessEntry := model.AuditEntry{
		Action: model.AuditLogActionUnauthorizedAccessAttempt,
		Status: model.AuditLogStatusFailure,
		Model:  model.AuditData{"endpoint": "POST /api/v2/graphs/cypher"},
	}
	...
	tt := []testData{
		{
			...
			setupMocks: func(t *testing.T, mocks *mock) {
				...
				mocks.mockDatabase.EXPECT().AppendAuditLog(gomock.Any(), intentAuditEntry).Times(1)
				mocks.mockDatabase.EXPECT().AppendAuditLog(gomock.Any(), successAuditEntry).Times(1)
			},
			expected: expected{
				responseCode:   http.StatusOK,
				responseBody:   `{"data":{"node_keys": ["apple", "ball", "key", "zebra"], "edge_keys": ["apple", "ball", "key", "zebra"], "nodes":{"1":{"label":"label","properties": {"apple": "snake", "zebra": "elmo", "key": "value", "ball": "value"},"kind":"","kinds":null, "objectId":"","isTierZero":false,"isOwnedObject":false,"isDecoyObject":false,"lastSeen":"0001-01-01T00:00:00Z"}},"edges":[{"id":"","source":"source","target":"","label":"","properties": {"apple": "snake", "zebra": "elmo", "key": "value", "ball": "value"},"kind":"","lastSeen":"0001-01-01T00:00:00Z"}],"literals":[]}}`,
		...
		},
		{
			...
			setupMocks: func(t *testing.T, mocks *mock) {
				...
				mocks.mockDatabase.EXPECT().AppendAuditLog(gomock.Any(), intentAuditEntry).Times(1)
				mocks.mockDatabase.EXPECT().AppendAuditLog(gomock.Any(), unauthorizedAccessEntry).Times(1)
				mocks.mockDatabase.EXPECT().AppendAuditLog(gomock.Any(), failureAuditEntry).Times(1)
			},
			expected: expected{
		...
		},
		{
			...
			expected: expected{
				responseCode:   http.StatusOK,
				responseBody:   `{"data":{"edges":[{"id":"","kind":"","label":"","lastSeen":"0001-01-01T00:00:00Z","source":"source","target":""}],"literals": [],"node_keys":["key"],"nodes":{"1":{"isOwnedObject":false,"isDecoyObject":false,"isTierZero":false,"kind":"","kinds":null,"label":"label","lastSeen":"0001-01-01T00:00:00Z","objectId":"","properties":{"key":"value"}}}}}`,
				responseHeader: http.Header{"Content-Type": []string{"application/json"}},
			},
		},
		{
		...
		},
		{
			...
			expected: expected{
				responseCode:   http.StatusOK,
				responseBody:   `{"data":{"edges":[{"id":"","kind":"","label":"","lastSeen":"0001-01-01T00:00:00Z","source":"source","target":"1"},{"id":"","kind":"HIDDEN","label":"** Hidden Edge **","lastSeen":"0001-01-01T00:00:00Z","source":"source","target":"2"},{"id":"","kind":"HIDDEN","label":"** Hidden Edge **","lastSeen":"0001-01-01T00:00:00Z","source":"2","target":"1"}],"literals":[],"node_keys":["domainsid"],"nodes":{"1":{"isOwnedObject":false,"isDecoyObject":false,"isTierZero":false,"kind":"","kinds":["kinds"],"label":"label","lastSeen":"0001-01-01T00:00:00Z","objectId":"","properties":{"domainsid":"testenv"}},"2":{"hidden":true,"isOwnedObject":false,"isDecoyObject":false,"isTierZero":false,"kind":"HIDDEN","kinds":[],"label":"** Hidden kinds Object **","lastSeen":"0001-01-01T00:00:00Z","objectId":"HIDDEN"},"source":{"isOwnedObject":false,"isDecoyObject":false,"isTierZero":false,"kind":"","kinds":["kinds"],"label":"labelSource","lastSeen":"0001-01-01T00:00:00Z","objectId":"","properties":{"domainsid":"testenv"}}}}}`,
				responseHeader: http.Header{"Content-Type": []string{"application/json"}},
			},
		},
		{
			...
			expected: expected{
				responseCode:   http.StatusOK,
				responseBody:   `{"data":{"nodes":{"1":{"hidden":true,"isOwnedObject":false,"isDecoyObject":false,"isTierZero":false,"kind":"HIDDEN","kinds":[],"label":"** Hidden kinds Object **","lastSeen":"0001-01-01T00:00:00Z","objectId":"HIDDEN"},"2":{"hidden":true,"isOwnedObject":false,"isDecoyObject":false,"isTierZero":false,"kind":"HIDDEN","kinds":[],"label":"** Hidden kinds Object **","lastSeen":"0001-01-01T00:00:00Z","objectId":"HIDDEN"}},"edges":[{"id":"","source":"source","target":"1","label":"** Hidden Edge **","kind":"HIDDEN","lastSeen":"0001-01-01T00:00:00Z"}],"literals":[]}}`,
				responseHeader: http.Header{"Content-Type": []string{"application/json"}},
			},
		},
	}
