...
func (s *ESC6bHarnessDC2) Setup(graphTestContext *GraphTestContext) {
	...
	graphTestContext.NewRelationship(s.Domain0, s.Domain01, ad.SameForestTrusted)
	graphTestContext.NewRelationship(s.Domain01, s.Domain0, ad.SameForestTrusted)
	graphTestContext.NewRelationship(s.Domain02, s.Domain01, ad.SameForestTrusted)
	graphTestContext.NewRelationship(s.Domain01, s.Domain02, ad.SameForestTrusted)
	graphTestContext.NewRelationship(s.Domain12, s.Domain11, ad.SameForestTrusted)
	graphTestContext.NewRelationship(s.Domain11, s.Domain12, ad.SameForestTrusted)
