...
func (s *ADCSESC1Harness) Setup(gt *GraphTestContext) {
	s.DomainSid = RandomDomainSID()
	s.Domain1 = gt.NewActiveDirectoryDomain("domain 1", s.DomainSid, false, true)
	s.AuthStore1 = gt.NewActiveDirectoryNTAuthStore("ntauthstore 1", s.DomainSid)
	s.EnterpriseCA1 = gt.NewActiveDirectoryEnterpriseCA("eca 1", s.DomainSid)
	s.RootCA1 = gt.NewActiveDirectoryRootCA("rca 1", s.DomainSid)
	s.CertTemplate1 = gt.NewActiveDirectoryCertTemplate("certtemplate 1", s.DomainSid, false, true, true, 1, 0)
	s.Group11 = gt.NewActiveDirectoryGroup("group1-1", s.DomainSid)
	s.Group12 = gt.NewActiveDirectoryGroup("group1-2", s.DomainSid)
	s.Group13 = gt.NewActiveDirectoryGroup("group1-3", s.DomainSid)
	s.User11 = gt.NewActiveDirectoryUser("user1-1", s.DomainSid)
	s.User12 = gt.NewActiveDirectoryUser("user1-2", s.DomainSid)
	s.User13 = gt.NewActiveDirectoryUser("user1-3", s.DomainSid)
	s.User14 = gt.NewActiveDirectoryUser("user1-4", s.DomainSid)
	s.User15 = gt.NewActiveDirectoryUser("user1-5", s.DomainSid)
	...
	gt.NewRelationship(s.CertTemplate1, s.EnterpriseCA1, ad.PublishedTo)
	gt.NewRelationship(s.Group11, s.CertTemplate1, ad.Enroll)
	gt.NewRelationship(s.Group12, s.EnterpriseCA1, ad.Enroll)
	gt.NewRelationship(s.Group13, s.EnterpriseCA1, ad.Enroll)
	gt.NewRelationship(s.Group13, s.CertTemplate1, ad.Enroll)

	gt.NewRelationship(s.User15, s.Group11, ad.MemberOf)
	gt.NewRelationship(s.User13, s.Group11, ad.MemberOf)
	gt.NewRelationship(s.User11, s.Group11, ad.MemberOf)
	gt.NewRelationship(s.User13, s.Group12, ad.MemberOf)
	gt.NewRelationship(s.User14, s.Group12, ad.MemberOf)
	gt.NewRelationship(s.User12, s.Group13, ad.MemberOf)
	gt.NewRelationship(s.User11, s.Group13, ad.MemberOf)

	s.DomainSid2 = RandomDomainSID()
	s.Domain2 = gt.NewActiveDirectoryDomain("domain 2", s.DomainSid2, false, true)
	s.RootCA2 = gt.NewActiveDirectoryRootCA("rca2", s.DomainSid2)
	s.AuthStore2 = gt.NewActiveDirectoryNTAuthStore("authstore2", s.DomainSid2)
	s.EnterpriseCA21 = gt.NewActiveDirectoryEnterpriseCA("eca2-1", s.DomainSid2)
	s.EnterpriseCA22 = gt.NewActiveDirectoryEnterpriseCA("eca2-2", s.DomainSid2)
	s.Group21 = gt.NewActiveDirectoryGroup("group2-1", s.DomainSid2)
	s.Group22 = gt.NewActiveDirectoryGroup("group2-2", s.DomainSid2)
	s.CertTemplate2 = gt.NewActiveDirectoryCertTemplate("certtemplate 2", s.DomainSid2, false, true, true, 1, 0)

	gt.NewRelationship(s.RootCA2, s.Domain2, ad.RootCAFor)
	gt.NewRelationship(s.AuthStore2, s.Domain2, ad.NTAuthStoreFor)
	gt.NewRelationship(s.EnterpriseCA21, s.AuthStore2, ad.TrustedForNTAuth)
	gt.NewRelationship(s.EnterpriseCA21, s.RootCA2, ad.EnterpriseCAFor)
	gt.NewRelationship(s.EnterpriseCA22, s.RootCA2, ad.IssuedSignedBy)
	gt.NewRelationship(s.Group21, s.EnterpriseCA22, ad.Enroll)
	gt.NewRelationship(s.Group21, s.CertTemplate2, ad.Enroll)
	gt.NewRelationship(s.CertTemplate2, s.EnterpriseCA22, ad.PublishedTo)
	gt.NewRelationship(s.CertTemplate2, s.EnterpriseCA21, ad.PublishedTo)
	gt.NewRelationship(s.Group22, s.CertTemplate2, ad.Enroll)
	gt.NewRelationship(s.Group22, s.EnterpriseCA21, ad.Enroll)

	s.DomainSid3 = RandomDomainSID()
	s.Domain3 = gt.NewActiveDirectoryDomain("domain 3", s.DomainSid3, false, true)
	s.RootCA3 = gt.NewActiveDirectoryRootCA("rca3", s.DomainSid3)
	s.AuthStore3 = gt.NewActiveDirectoryNTAuthStore("authstore3", s.DomainSid3)
	s.EnterpriseCA31 = gt.NewActiveDirectoryEnterpriseCA("eca3-1", s.DomainSid3)
	s.EnterpriseCA32 = gt.NewActiveDirectoryEnterpriseCA("eca3-2", s.DomainSid3)
	s.Group31 = gt.NewActiveDirectoryGroup("group3-1", s.DomainSid3)
	s.Group32 = gt.NewActiveDirectoryGroup("group3-2", s.DomainSid3)
	s.CertTemplate3 = gt.NewActiveDirectoryCertTemplate("certtemplate 3", s.DomainSid2, false, true, true, 1, 0)

	gt.NewRelationship(s.RootCA3, s.Domain3, ad.RootCAFor)
	gt.NewRelationship(s.AuthStore3, s.Domain3, ad.NTAuthStoreFor)
	gt.NewRelationship(s.EnterpriseCA31, s.AuthStore3, ad.TrustedForNTAuth)
	gt.NewRelationship(s.EnterpriseCA31, s.RootCA3, ad.EnterpriseCAFor)
	gt.NewRelationship(s.EnterpriseCA32, s.AuthStore3, ad.TrustedForNTAuth)
	gt.NewRelationship(s.CertTemplate3, s.EnterpriseCA31, ad.PublishedTo)
	gt.NewRelationship(s.CertTemplate3, s.EnterpriseCA32, ad.PublishedTo)
	gt.NewRelationship(s.Group31, s.EnterpriseCA32, ad.Enroll)
