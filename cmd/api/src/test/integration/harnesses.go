...
func (s *TrustDCSyncHarness) Setup(testCtx *GraphTestContext) {
	...
	testCtx.NewRelationship(s.DomainA, s.DomainB, ad.IntraForestTrusted)
	testCtx.NewRelationship(s.DomainB, s.DomainA, ad.IntraForestTrusted)
	testCtx.NewRelationship(s.DomainA, s.DomainC, ad.IntraForestTrusted)

	testCtx.NewRelationship(s.DomainB, s.DomainD, ad.IntraForestTrusted)
	testCtx.NewRelationship(s.DomainD, s.DomainB, ad.IntraForestTrusted)
...
func (s *ESC6bHarnessDC2) Setup(graphTestContext *GraphTestContext) {
	...
	graphTestContext.NewRelationship(s.Domain0, s.Domain01, ad.IntraForestTrusted, graph.AsProperties(graph.PropertyMap{ad.TrustType: "ParentChild"}))
	graphTestContext.NewRelationship(s.Domain01, s.Domain0, ad.IntraForestTrusted, graph.AsProperties(graph.PropertyMap{ad.TrustType: "ParentChild"}))
	graphTestContext.NewRelationship(s.Domain02, s.Domain01, ad.IntraForestTrusted, graph.AsProperties(graph.PropertyMap{ad.TrustType: "ParentChild"}))
	graphTestContext.NewRelationship(s.Domain01, s.Domain02, ad.IntraForestTrusted, graph.AsProperties(graph.PropertyMap{ad.TrustType: "ParentChild"}))
	graphTestContext.NewRelationship(s.Domain12, s.Domain11, ad.IntraForestTrusted, graph.AsProperties(graph.PropertyMap{ad.TrustType: "ParentChild"}))
	graphTestContext.NewRelationship(s.Domain11, s.Domain12, ad.IntraForestTrusted, graph.AsProperties(graph.PropertyMap{ad.TrustType: "ParentChild"}))
	graphTestContext.NewRelationship(s.Domain11, s.Domain1, ad.IntraForestTrusted)
	graphTestContext.NewRelationship(s.Domain1, s.Domain11, ad.IntraForestTrusted)
