...
type AssetGroupTagSelectorNodeData interface {
	...
	UpdateSelectorNodesByNodeId(ctx context.Context, assetGroupTagId, selectorId int, certified model.AssetGroupCertification, certifiedBy null.String, nodeId graph.ID, displayName string, historyNote null.String) error
...
func (s *BloodhoundDB) UpdateSelectorNodesByNodeId(ctx context.Context, assetGroupTagId, selectorId int, certified model.AssetGroupCertification, certifiedBy null.String, nodeId graph.ID, displayName string, historyNote null.String) error {
	return s.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
