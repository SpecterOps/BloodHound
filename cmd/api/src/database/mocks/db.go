...
// GetAllOIDCProviders mocks base method.
func (m *MockDatabase) GetAllOIDCProviders(arg0 context.Context) ([]model.OIDCProvider, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllOIDCProviders", arg0)
	ret0, _ := ret[0].([]model.OIDCProvider)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllOIDCProviders indicates an expected call of GetAllOIDCProviders.
func (mr *MockDatabaseMockRecorder) GetAllOIDCProviders(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllOIDCProviders", reflect.TypeOf((*MockDatabase)(nil).GetAllOIDCProviders), arg0)
}
