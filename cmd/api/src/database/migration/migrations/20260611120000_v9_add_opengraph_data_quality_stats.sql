...
CREATE INDEX IF NOT EXISTS idx_data_quality_stats_created_at
    ON data_quality_stats (created_at);
...
CREATE INDEX IF NOT EXISTS idx_data_quality_stats_aggregation_created_at
    ON data_quality_stats_aggregation (created_at);
