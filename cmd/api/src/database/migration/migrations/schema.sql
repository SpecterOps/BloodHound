...
INSERT INTO feature_flags (created_at, updated_at, key, name, description, enabled, user_updatable) VALUES (current_timestamp, current_timestamp, 'analyze_hybrid_paths', 'Include Hybrid Paths in Analysis', 'Enables analysis of attack paths between Azure and Active Directory.', false, true);
...
INSERT INTO feature_flags (created_at, updated_at, key, name, description, enabled, user_updatable) VALUES (current_timestamp, current_timestamp, 'reconciliation', 'Reconciliation', 'Enables Reconciliation', true, true);
