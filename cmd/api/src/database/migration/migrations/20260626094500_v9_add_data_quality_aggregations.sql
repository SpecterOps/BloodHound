...
CREATE INDEX IF NOT EXISTS idx_data_quality_aggregations_created_at ON data_quality_aggregations (created_at);
CREATE INDEX IF NOT EXISTS idx_data_quality_aggregations_run_id ON data_quality_aggregations (run_id);
