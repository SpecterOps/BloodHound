...
('Incoming Forest Trust Builders', false, true, E'MATCH (n:Group) \nWHERE m.objectid ENDS WITH ''-557''\nRETURN n;', E'Members of this group can create incoming trusts that allow TGT delegation which can lead to compromise of the forest.'),
