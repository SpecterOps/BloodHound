...
BEGIN
	...
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'Owns', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'GenericAll', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'GenericWrite', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'WriteOwner', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'WriteDacl', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'MemberOf', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ForceChangePassword', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'AllExtendedRights', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'AddMember', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'HasSession', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'Contains', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'GPLink', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'AllowedToDelegate', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'CoerceToTGT', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'GetChanges', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'GetChangesAll', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'GetChangesInFilteredSet', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'CrossForestTrust', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'SameForestTrust', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'SpoofSIDHistory', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'AbuseTGTDelegation', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'AllowedToAct', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'AdminTo', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'CanPSRemote', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'CanRDP', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ExecuteDCOM', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'HasSIDHistory', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'AddSelf', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'DCSync', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ReadLAPSPassword', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ReadGMSAPassword', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'DumpSMSAPassword', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'SQLAdmin', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'AddAllowedToAct', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'WriteSPN', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'AddKeyCredentialLink', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'LocalToComputer', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'MemberOfLocalGroup', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'RemoteInteractiveLogonRight', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'SyncLAPSPassword', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'WriteAccountRestrictions', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'WriteGPLink', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'RootCAFor', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'DCFor', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'PublishedTo', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ManageCertificates', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ManageCA', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'DelegatedEnrollmentAgent', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'Enroll', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'HostsCAService', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'WritePKIEnrollmentFlag', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'WritePKINameFlag', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'NTAuthStoreFor', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'TrustedForNTAuth', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'EnterpriseCAFor', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'IssuedSignedBy', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'GoldenCert', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'EnrollOnBehalfOf', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'OIDGroupLink', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ExtendedByPolicy', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC1', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC3', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC4', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC6a', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC6b', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC9a', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC9b', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC10a', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC10b', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ADCSESC13', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'SyncedToEntraUser', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'CoerceAndRelayNTLMToSMB', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'CoerceAndRelayNTLMToADCS', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'WriteOwnerLimitedRights', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'WriteOwnerRaw', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'OwnsLimitedRights', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'OwnsRaw', '', false);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ClaimSpecialIdentity', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'CoerceAndRelayNTLMToLDAP', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'CoerceAndRelayNTLMToLDAPS', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ContainsIdentity', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'PropagatesACEsTo', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'GPOAppliesTo', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'CanApplyGPO', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'HasTrustKeys', '', true);
	PERFORM genscript_upsert_schema_edge_kind(extension_id, 'ProtectAdminGroups', '', false);
