...
func (s *Server) sendLoginForm(w http.ResponseWriter, r *http.Request, req *IdpAuthnRequest, toast string) {
...
func (s *Server) HandleLogin(c web.C, w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewEncoder(w).Encode(session); err != nil {
		s.logger.Printf("Error encoding session: %v", err)
	}
}
...
func (s *Server) HandleListSessions(c web.C, w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		s.logger.Printf("Error encoding sessions: %v", err)
	}
}
