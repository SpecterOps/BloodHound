...
func convertAzureApp(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.App
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf("Error deserializing azure application: %v", err))
	} else {
		converted.NodeProps = append(converted.NodeProps, ein.ConvertAZAppToNode(data, nowUTC))
		converted.RelProps = append(converted.RelProps, ein.ConvertAZAppRelationships(data)...)
	}
}

func convertAzureVMScaleSet(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.VMScaleSet
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure virtual machine scale set", err))
	} else {
		converted.NodeProps = append(converted.NodeProps, ein.ConvertAZVMScaleSetToNode(data, nowUTC))
		converted.RelProps = append(converted.RelProps, ein.ConvertAZVMScaleSetRelationships(data)...)
	}
}

func convertAzureVMScaleSetRoleAssignment(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureAppOwner(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var (
...
func convertAzureAppRoleAssignment(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureDevice(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.Device
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure device", err))
	} else {
		converted.NodeProps = append(converted.NodeProps, ein.ConvertAZDeviceToNode(data, nowUTC))
		converted.RelProps = append(converted.RelProps, ein.ConvertAZDeviceRelationships(data)...)
	}
}

func convertAzureDeviceOwner(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var (
...
func convertAzureFunctionApp(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.FunctionApp
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure function app", err))
	} else {
		converted.NodeProps = append(converted.NodeProps, ein.ConvertAzureFunctionAppToNode(data, nowUTC))
		converted.RelProps = append(converted.RelProps, ein.ConvertAzureFunctionAppToRels(data)...)
	}
}

func convertAzureFunctionAppRoleAssignment(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.AzureRoleAssignments
...
func convertAzureGroup(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.Group
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure group", err))
	} else {
		converted.NodeProps = append(converted.NodeProps, ein.ConvertAzureGroupToNode(data, nowUTC))
...
func convertAzureGroupMember(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var (
...
func convertAzureGroupOwner(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var (
...
func convertAzureKeyVault(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.KeyVault
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure keyvault", err))
	} else {
		node, rel := ein.ConvertAzureKeyVault(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
		converted.RelProps = append(converted.RelProps, rel)
	}
}

func convertAzureKeyVaultAccessPolicy(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var (
...
func convertAzureKeyVaultContributor(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var (
...
func convertAzureKeyVaultKVContributor(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var (
...
func convertAzureKeyVaultOwner(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var (
...
func convertAzureKeyVaultUserAccessAdmin(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureManagementGroupDescendant(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureManagementGroupOwner(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureManagementGroupUserAccessAdmin(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureManagementGroup(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.ManagementGroup
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure management group", err))
	} else {
		node, rel := ein.ConvertAzureManagementGroup(data, nowUTC)
		converted.RelProps = append(converted.RelProps, rel)
		converted.NodeProps = append(converted.NodeProps, node)
	}
}

func convertAzureResourceGroup(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.ResourceGroup
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure resource group", err))
	} else {
		node, rel := ein.ConvertAzureResourceGroup(data, nowUTC)
		converted.RelProps = append(converted.RelProps, rel)
		converted.NodeProps = append(converted.NodeProps, node)
	}
}

func convertAzureResourceGroupOwner(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureResourceGroupUserAccessAdmin(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureRole(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.Role
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure role", err))
	} else {
		node, rel := ein.ConvertAzureRole(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
		converted.RelProps = append(converted.RelProps, rel)
	}
}

func convertAzureRoleAssignment(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureServicePrincipal(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.ServicePrincipal
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure service principal owner", err))
	} else {
		nodes, rels := ein.ConvertAzureServicePrincipal(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, nodes...)
		converted.RelProps = append(converted.RelProps, rels...)
	}
}

func convertAzureServicePrincipalOwner(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var (
...
func convertAzureSubscription(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data azureModels.Subscription
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure subscription", err))
	} else {
		node, rel := ein.ConvertAzureSubscription(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
		converted.RelProps = append(converted.RelProps, rel)
	}
}

func convertAzureSubscriptionOwner(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureSubscriptionUserAccessAdmin(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureTenant(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.Tenant
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure tenant", err))
	} else {
		converted.NodeProps = append(converted.NodeProps, ein.ConvertAzureTenantToNode(data, nowUTC))
	}
}

func convertAzureUser(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.User
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure user", err))
	} else {
		node, onPremNode, rel := ein.ConvertAzureUser(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
...
func convertAzureVirtualMachine(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.VirtualMachine
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure virtual machine", err))
	} else {
		node, rels := ein.ConvertAzureVirtualMachine(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
		converted.RelProps = append(converted.RelProps, rels...)
	}
}

func convertAzureVirtualMachineAdminLogin(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureVirtualMachineAvereContributor(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureVirtualMachineContributor(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureVirtualMachineVMContributor(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureVirtualMachineOwner(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureVirtualMachineUserAccessAdmin(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
...
func convertAzureManagedCluster(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	...
	if err := json.Unmarshal(raw, &data); err != nil {
		...
		node, rels := ein.ConvertAzureManagedCluster(data, NodeResourceGroupID, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
		converted.RelProps = append(converted.RelProps, rels...)
	}
}

func convertAzureManagedClusterRoleAssignment(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.AzureRoleAssignments
...
func convertAzureContainerRegistry(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.ContainerRegistry
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure container registry", err))
	} else {
		node, rels := ein.ConvertAzureContainerRegistry(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
		converted.RelProps = append(converted.RelProps, rels...)
	}
}

func convertAzureWebApp(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.WebApp
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure web app", err))
	} else {
		node, relationships := ein.ConvertAzureWebApp(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
		converted.RelProps = append(converted.RelProps, relationships...)
	}
}

func convertAzureContainerRegistryRoleAssignment(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.AzureRoleAssignments
...
func convertAzureWebAppRoleAssignment(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.AzureRoleAssignments
...
func convertAzureLogicApp(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.LogicApp
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure logic app", err))
	} else {
		node, relationships := ein.ConvertAzureLogicApp(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
		converted.RelProps = append(converted.RelProps, relationships...)
	}
}

func convertAzureLogicAppRoleAssignment(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.AzureRoleAssignments
...
func convertAzureAutomationAccount(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.AutomationAccount
	if err := json.Unmarshal(raw, &data); err != nil {
		slog.Error(fmt.Sprintf(SerialError, "azure automation account", err))
	} else {
		node, relationships := ein.ConvertAzureAutomationAccount(data, nowUTC)
		converted.NodeProps = append(converted.NodeProps, node)
		converted.RelProps = append(converted.RelProps, relationships...)
	}
}

func convertAzureAutomationAccountRoleAssignment(raw json.RawMessage, converted *ConvertedAzureData, nowUTC time.Time) {
	var data models.AzureRoleAssignments
