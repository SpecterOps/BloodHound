...
func ConnectGraph(ctx context.Context, cfg config.Configuration, defaultDriverName string) (*graph.DatabaseSwitch, error) {
	var connectionString string

	if driverName, err := tools.LookupGraphDriver(ctx, cfg, defaultDriverName); err != nil {
		return nil, err
	} else {
		switch driverName {
