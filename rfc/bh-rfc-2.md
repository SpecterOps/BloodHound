...
```
feat: BED-5555 - Adds table view to Explore page
```

Detailed example:

```
docs(bh-rfc-2): BED-5475 - Address PR feedback
...
```
feat(auth): BED-5555 - Introduces required facial recognition sign in
