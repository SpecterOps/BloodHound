...
4.  If needing to test AzureHound's connectitity to Azure; keep the command prompt open and follow [Run an On Demand Scan](/collect-data/enterprise-collection/on-demand-scan)
