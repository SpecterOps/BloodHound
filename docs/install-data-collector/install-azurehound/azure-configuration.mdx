...
6.  In the **Overview** menu, copy the **Application (client) ID** and **Directory (tenant) ID** to be used later in [AzureHound Enterprise Local Configuration](/hc/en-us/articles/Create-an-AzureHound-Configuration)
<Frame>
...
We highly recommend using certificate-based authentication. If you do not already have a certificate created, follow the article [AzureHound Enterprise Local Configuration](/hc/en-us/articles/Create-an-AzureHound-Configuration) and then return back here.
...
8.  Locate the "cert.pem" file created during AzureHound setup (either on your own, or utilizing the instructions at [AzureHound Enterprise Local Configuration](/hc/en-us/articles/Create-an-AzureHound-Configuration))
...
10. In the bottom of the window, select **Add
    ...
    **
11. Continue to [Run and Upgrade AzureHound (Windows, Docker, or Kubernetes)](/hc/en-us/articles/Install-and-Upgrade-AzureHound-Windows-Docker-or-Kubernetes)
