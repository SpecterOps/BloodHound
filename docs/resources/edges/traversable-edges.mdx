...
|                      |                           |                          |
|----------------------|---------------------------|--------------------------|
| ADCSESC1             | CanApplyGPO               | HasSIDHistory            |
| ADCSESC10a           | CanPSRemote               | HasSession               |
| ADCSESC10b           | CanRDP                    | MemberOf                 |
| ADCSESC13            | CoerceAndRelayNTLMToADCS  | Owns                     |
| ADCSESC3             | CoerceAndRelayNTLMToLDAP  | OwnsLimitedRights        |
| ADCSESC4             | CoerceAndRelayNTLMToLDAPS | PropagatesACEsTo         |
| ADCSESC6a            | CoerceAndRelayNTLMToSMB   | ReadGMSAPassword         |
| ADCSESC6b            | CoerceToTGT               | ReadLAPSPassword         |
| ADCSESC9a            | ContainsIdentity          | SQLAdmin                 |
...
| AllowedToDelegate    | GPOAppliesTo              |                          |
