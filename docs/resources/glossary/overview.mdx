...
A graph query language used to search and analyze data in BloodHound. To learn more about using Cypher in BloodHound, see [Searching with Cypher](/analyze-data/cypher/searching-with-cypher).
