...
Instructions to upgrade your collector may be found [here](/install-data-collector/install-sharphound/upgrade-sharphound). Our Customer Success team will begin reaching out to all customers still running SharpHound v1 and would be happy to help if you require it.
...
For instructions on upgrading your collector, see [Install and Upgrade SharpHound Enterprise](/install-data-collector/install-sharphound/upgrade-sharphound).
