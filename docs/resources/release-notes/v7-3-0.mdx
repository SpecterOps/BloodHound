---
title: "2025-04-21 Release Notes (v7.3.0)"
---
...
- **BloodHound (v7.3.0)**
  ...
  - Bug Fixes
    ...
    - The "Collapse all" button on Entity panels is functioning again.
- **SharpHound (v2.6.5)**
  - New and Improved Features
  ...
  - Bug Fixes
    - HostsCAService edges will now generate as a result of CertServices collections and will validate that the target computer is active before creating the edge.
    - Resolved an issue where timezone offsets would occasionally be applied twice on object creation timestamps.
    - SMB information will no longer be collected in DCOnly (AD Structure) collections.
- **AzureHound (v2.3.1)**
