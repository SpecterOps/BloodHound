...
1. Download sample data for [Active Directory](https://github.com/SpecterOps/BloodHound/docs/assets/sample-data/ad_example_data.zip) or [Azure](https://github.com/SpecterOps/BloodHound/docs/assets/sample-data/azurehound_example.zip)
