...
- Non-personal API key/ID pairs, for integrations like [Splunk](/integrations/integrations/splunk) or [Sentinel](/integrations/integrations/sentinel)
...
<CardGroup>
  <Card
    ...
    icon="paperclip"
    href="/assets/bloodhound-api-collection.json"
    iconType="solid"
    horizontal
  />
</CardGroup>
