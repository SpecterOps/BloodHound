...
<Frame>
  ![Generate API Tokens](/assets/image1-2.png)
</Frame>
...
4. You may now utilize this key ID pair for [calling the API](#calling-the-api)

## Create a personal API Key/ID pair

BloodHound users can create personal API Key/ID pairs from their "My Profile" section.

1. In the top-right corner click <Icon icon="gear" iconType="solid" /> <Icon icon="arrow-right" iconType="solid" /> **My Profile**.

<Frame>
  ![Create Token](/assets/image1-3.png)
</Frame>

1. Click **API Key Management**.

<Frame>
  ![API Key Mangement](/assets/image1-7.png)
</Frame>

1. Click **Create Token**.

<Frame>
  ![Create Token](/assets/image1-4.png)
</Frame>

1. Give the token a descriptive name and click **Save**.

<Frame>
  ![Create Token](/assets/image1-5.png)
</Frame>
...
<Frame>
  ![API Key Pair](/assets/image1-6.png)
</Frame>

1. You may now utilize this key/ID pair for calling the API.
...
<CardGroup cols={2}>
  <Card title="apiclient.py 10KB" icon="paperclip" iconType="solid" horizontal href="/assets/apiclient.py">
