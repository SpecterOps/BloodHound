...
7.  Under **Basic SAML Configuration**, enter the following information:
    * **Identifier (Entity ID)**: `https://<your-bloodhound-url>/api/v2/saml/metadata`
    * **Reply URL (Assertion Consumer Service URL)**: `https://<your-bloodhound-url>/api/v2/saml/acs`
    * **Sign on URL**: `https://<your-bloodhound-url>`
