...
<Card title="Continuously monitor, prioritize, and eliminate attack path risk across your environment." img="../../images/enterprise-logo.png">
    ...
    <br/> Leverage features like scheduled data collection, data reconciliation, and reporting. 

    <br/> Manage attack paths with exposure measurement and remediation guidance. 
