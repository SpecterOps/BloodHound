...
description: "This article describes the step-by-step process of deploying and using BloodHound Enterprise, which is to be followed after being provided a [BloodHound Enterprise instance](/hc/en-us/articles/BloodHound-Enterprise-Tenant)."
...
Information about the security of your BloodHound Enterprise instance is available in the article [BloodHound Enterprise Security Overview](/hc/en-us/articles/BloodHound-Enterprise-Security-Overview).
...
* SAML 2.0-based Single-Sign-On as described in [SAML in BloodHound Enterprise](/hc/en-us/articles/SAML-in-BloodHound).
...
One of four access control roles can be granted to every user as described in the article [User Roles](/hc/en-us/articles/Administering-users-and-roles).
...
1.  [SharpHound Enterprise System Requirements](/hc/en-us/articles/SharpHound-Enterprise-System-Requirements-and-Deployment-Process)
2.  Deploy and maintain SharpHound: [Install and Upgrade SharpHound Enterprise](/hc/en-us/articles/Install-and-Upgrade-SharpHound-Enterprise)
    * Before deploying, we recommend reading the [SharpHound Service Hardening Guidelines](/hc/en-us/articles/SharpHound-Enterprise-Service-Hardening).
3.  SharpHound Enterprise also supports [Cross-Trust Collection](/hc/en-us/articles/SharpHound-Enterprise-Cross-Trust-Collection).
...
1.  [AzureHound Enterprise System Requirements and Deployment Process](/hc/en-us/articles/AzureHound-Enterprise-System-Requirements-and-Deployment-Process)
2.  Configure Azure: [AzureHound Enterprise Azure Configuration](/hc/en-us/articles/AzureHound-Enterprise-Azure-Configuration)
3.  Create your AzureHound configuration: [AzureHound Enterprise Local Configuration](/hc/en-us/articles/Create-an-AzureHound-Configuration)
4.  Deploy and maintain AzureHound: [Run and Upgrade AzureHound (Windows, Docker, or Kubernetes)](/hc/en-us/articles/Install-and-Upgrade-AzureHound-Windows-Docker-or-Kubernetes)
...
* Scope Tier Zero for your environment, read [Tier Zero: Members and Modification](/hc/en-us/articles/Tier-Zero-Members-and-Modification).
* Mark your environment's Tier Zero objects in BHE, read [Modifying Tier Zero](/hc/en-us/articles/Modifying-Tier-Zero).
...
* [Working with the BloodHound Enterprise API](/hc/en-us/articles/Working-with-the-BloodHound-API)
* [Overview of BloodHound Integrations](/hc/en-us/articles/Overview-of-BloodHound-Integrations)
