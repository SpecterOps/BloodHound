...
* Deployment of a domain-joined Windows server to run the service; see [SharpHound Enterprise System Requirements and Deployment Process](/hc/en-us/articles/9294790783259-SharpHound-Enterprise-System-Requirements-and-Deployment-Process)
...
8.  SmartScreen may display a warning if you are running Microsoft Defender:
    * Click **More info**.
<Frame>
  <img src="/hc/images/image-41.png" alt=""/>
</Frame>
    * Validate the publisher shows **Specter Ops, Inc.** then click **Run anyway**.
<Frame>
  <img src="/hc/images/image-42.png" alt=""/>
</Frame>
...
<Frame>
  <img src="/hc/images/image-43.png" alt=""/>
</Frame>


10. Click **Install**.
<Frame>
  <img src="/hc/images/image-44.png" alt=""/>
</Frame>


11. Provide credentials for your SharpHound service account in the format: _DOMAIN\\username_
    * _If using a gMSA, according to our [Hardening Guidelines](/hc/en-us/articles/12400091052955-SharpHound-Enterprise-Service-Hardening), you must provide the credentials for a normal user account with local administrator access to the system, then post-installation, change the service to run as the gMSA as described in [Add the gMSA to the SharpHound Enterprise service](/hc/en-us/articles/9295298941723-Create-a-gMSA-for-use-with-SharpHound-Enterprise)._
<Frame>
  <img src="/hc/images/image-45.png" alt=""/>
</Frame>


12. Click **Finish**.
<Frame>
  <img src="/hc/images/image-46.png" alt=""/>
</Frame>
...
<Frame>
  <img src="/hc/images/image-47.png" alt=""/>
</Frame>


14. If using a gMSA, according to our [Hardening Guidelines](/hc/en-us/articles/12400091052955-SharpHound-Enterprise-Service-Hardening), change the service to run as the gMSA as described in [Add the gMSA to the SharpHound Enterprise service](/hc/en-us/articles/9295298941723-Create-a-gMSA-for-use-with-SharpHound-Enterprise).
...
16. Change the files "settings.json" and "auth.json" in the configuration described in [SharpHound Enterprise Local Configuration](/hc/en-us/articles/9268639353115-SharpHound-Enterprise-Local-Configuration). In most cases, only the following needs to change:
    * In "settings.json"
    ...
    * [Create a BloodHound Enterprise collector client](/hc/en-us/articles/18346330027547-Create-a-BloodHound-Enterprise-collector-client), and then in "auth.json" set "Token" and "TokenID" to the values given after you created the client. This is the secret that the service authenticates with.
...
<Frame>
  <img src="/hc/images/image-48.png" alt=""/>
</Frame>
19. Perform your scan by either:
    1.  [Create a data collection schedule](/hc/en-us/articles/18502463306907-Create-a-data-collection-schedule)
    2.  [Run an On Demand Scan](/hc/en-us/articles/24687968208923-Run-an-On-Demand-Scan)
...
2.  Click on the gear icon in the top right corner, followed by **Download Collectors**
<Frame>
  <img src="/hc/images/image-49.png" alt=""/>
</Frame>


3.  Click **📥 Download SharpHound v#.#.# (.zip)** on the SharpHound version marked "(Latest)".
<Frame>
  <img src="/hc/images/image-50.png" alt=""/>
</Frame>
...
7.  Click **Finish**.
<Frame>
  <img src="/hc/images/image-51.png" alt=""/>
</Frame>
...
<Frame>
  <img src="/hc/images/image-52.png" alt=""/>
</Frame>

### The SharpHound Delegator Service won't start

Check the "TempDirectory" value in the configuration file "settings.json" described in [SharpHound Enterprise Local Configuration](/hc/en-us/articles/9268639353115-SharpHound-Enterprise-Local-Configuration).
