...
The certificate template is now vulnerable to the ESC1 technique. See [ADCSESC1](/hc/en-us/articles/22806798357659-ADCSESC1) for instructions.
...
See [ADCSESC1](/hc/en-us/articles/22806798357659-ADCSESC1) for instructions.
