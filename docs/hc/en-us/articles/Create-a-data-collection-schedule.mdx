...
* Creation of one SharpHound Enterprise client, see [Create a SharpHound Enterprise collector client](/hc/en-us/articles/Create-a-BloodHound-Enterprise-collector-client)
* Logged in as a user role which is authorized to modify clients, see [User Role Definitions](/hc/en-us/articles/Administering-users-and-roles)
