...
Follow the article: [Install BloodHound Community Edition with Docker Compose](/hc/en-us/articles/Install-BloodHound-Community-Edition-with-Docker-Compose)
...
3.  Building them from source, for details see the articles:
    1.  [SharpHound Community Edition](/hc/en-us/articles/SharpHound-Community-Edition)
    2.  [AzureHound Community Edition](/hc/en-us/articles/AzureHound-Community-Edition)

### Run a collection

SharpHound can simply be run from a domain-joined Windows system, while AzureHound needs to be run with a few arguments. Read more about running collectors and their flags in the section [BloodHound CE Collection](/hc/en-us/sections/BloodHound-CE-Collection).
...
1.  Through the BloodHound CE API endpoint '/api/v2/file-upload/', see [Working with the BloodHound API](/hc/en-us/articles/Working-with-the-BloodHound-API)
...
* The section [The BloodHound GUI](/hc/en-us/sections/The-BloodHound-GUI)
