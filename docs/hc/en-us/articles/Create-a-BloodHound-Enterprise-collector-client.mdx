...
* Having deployed a BloodHound Enterprise Tenant, see [BloodHound Enterprise Tenant](/hc/en-us/articles/BloodHound-Enterprise-Tenant)
* Logged in as a user role, which is authorized to create a new collector client, see [Administering users and roles](/hc/en-us/articles/Administering-users-and-roles)
