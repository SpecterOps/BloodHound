...
// kindInfoRow is the package-local DB row type for a schema_kind_info entry joined with
// the kind table for the kind name. db: tags drive pgx.RowToStructByName scanning.
