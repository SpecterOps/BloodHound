...
(TODO BED-9745) `GetConfig` is also used internally by the Bloodhound application, allowing relevant modules to read configuration values to control their config-dependant behavior.
