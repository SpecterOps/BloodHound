...
### 2. Define domain types and interfaces in `internal/services/services.go`
...
### 3. Implement persistence in `internal/appdb/appdb.go`
...
### 4. Define JSON views in `internal/handlers/views.go`
...
### 5. Define the handler interface and methods in `internal/handlers/handlers.go`
